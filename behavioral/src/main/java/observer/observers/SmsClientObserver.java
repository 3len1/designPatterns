 ...
 */
public class SmsClientObserver extends Observer {
    private static final Logger LOGGER = LoggerFactory.getLogger(SmsClientObserver.class);
    private Application application;

    public SmsClientObserver(Message message) {
        this.message = message;
        this.application = Application.SMS;
        message.attach(this);
    }
    ...
    @Override
    public void update() {
        LOGGER.info("Phone stream: " + message.getState());
    }
}
