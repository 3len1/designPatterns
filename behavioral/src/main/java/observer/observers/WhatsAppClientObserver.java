 ...
 */
public class WhatsAppClientObserver extends Observer {
    private static final Logger LOGGER = LoggerFactory.getLogger(WhatsAppClientObserver.class);
    private Application application;

    public WhatsAppClientObserver(Message message) {
        this.message = message;
        this.application = Application.WHATS_APP;
        message.attach(this);
    }
